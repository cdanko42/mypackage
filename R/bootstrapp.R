#' Bootstrapper for p-value
#'
#' @param t0 @description T-value calculated exogenously
#' @param xmax @description x-axis calibrator
#' @param n @description Number of elements
#' @param alpha @description Confidence level you're testing
#'
#' @return
#' @export
#'
